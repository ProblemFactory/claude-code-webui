...
const SESSION_FIELDS = {
  ...
  _turnWallSigs:       { owner: 'engine', persisted: null,      note: 'wall machine (2.369.0): wall signals accumulated on the CURRENT turn ({at, resetsAtMs, bucket, scopedName, key, slot} — key = the cache key the mark landed on (a REJECTION keys to the credential SLOT since 2026-09-07, a reading keys org-verified), slot = whether that key WAS the validated slot when the rejection arrived); the result record classifies' },
